...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{bab4/compiledstategraph.png}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node [start, below=of guide] (end) {Respons Akhir};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node [start, below=of const] (end) {Respons Jujur \& Aman};
