  ...
  return (
    <div className="flex w-full flex-col items-start gap-4 rounded-xl border-[1px] border-gray-300 p-6">
      ...
      <div className="flex w-full flex-col items-start gap-[6px]">
        <p className="min-w-fit text-sm font-medium">Tanggapan</p>
        <Textarea
          disabled={streaming}
          value={res.args}
          ...
          rows={4}
          placeholder="Tanggapan Anda di sini..."
        />
      </div>
...
function EditAndOrAcceptComponent({
  ...
  const header = editResponse.acceptAllowed ? "Ubah/Terima" : "Ubah";
    ...
    <div className="flex w-full flex-col items-start justify-start gap-2">
      ...
      <div className="flex w-full flex-col items-start gap-2">
        ...
        <Response
          ...
          handleSubmit={handleSubmit}
        />
        {streaming && <p className="text-sm text-gray-600">Berjalan...</p>}
        {streamFinished && (
          <p className="text-base font-medium text-green-600">
            Berhasil menyelesaikan eksekusi Graf.
          </p>
        )}
      </div>
    </div>
