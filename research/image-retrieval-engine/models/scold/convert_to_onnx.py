...
def create_inference_script(onnx_path="scold.onnx"):
    """
    Create a simple inference script for the ONNX model
    """
    inference_script = f'''import onnxruntime as ort
import numpy as np
from transformers import RobertaTokenizer
from PIL import Image
...
if __name__ == "__main__":
    model = SCOLDONNX()
    similarity = model.predict("path/to/image.jpg", "A maize leaf with bacterial spot")
    print(f"Similarity score: {{similarity}}")
'''
    
    script_path = "scold_onnx_inference.py"
...
if __name__ == "__main__":
    ...
    inference_script = create_inference_script(onnx_path)
